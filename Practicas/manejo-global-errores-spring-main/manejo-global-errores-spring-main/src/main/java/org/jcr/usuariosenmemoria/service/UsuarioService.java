...
public class UsuarioService {
    ...
    public UsuarioResponseDTO crearUsuario(UsuarioRequestDTO usuario) {
        ...
        Usuario usuarioCreado = Usuario.builder().nombre(usuario.nombre()).email(usuario.email()).build();
        return UsuarioResponseDTO.fromEntity(repository.guardar(usuarioCreado));
    }
